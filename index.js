...
import peerConnectionsRoutes from './routes/peerConnections.js';
...
// Peer connections & messaging routes (authentication required)
app.use('/peer', peerConnectionsRoutes);
